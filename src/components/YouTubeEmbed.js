...
export default function YoutubeEmbed({ slides }) {
  ...
  if (!slides || slides.length === 0) {
    return <div className="text-center text-gray-500">No video slides available.</div>;
  }
          ...
          >
            <div className="max-w-2xl border-gray-200 rounded-2xl shadow-sm dark:bg-gray-800 dark:border-gray-700 h-full">
              <div className="relative w-full" style={{ paddingBottom: '38%' }}>
                <iframe
                  src={`https://www.youtube.com/embed/${slides[current].videoId}`}
